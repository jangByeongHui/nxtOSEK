/*
 *  kernel_cfg.c
 *  Sat Oct 02 19:21:09 2021
 *  SG Version 2.00
 *  sg ./follower.oil -os=ECC2 -I/home/osek/nxtOSEK/ecrobot/../toppers_osek/sg/impl_oil -template=/home/osek/nxtOSEK/ecrobot/../toppers_osek/sg/lego_nxt.sgt
 */
...
const TaskType MoveTask = 0;
const TaskType StopTask = 1;
const TaskType nxtcar = 2;

extern void TASKNAME( MoveTask )( void );
extern void TASKNAME( StopTask )( void );
extern void TASKNAME( nxtcar )( void );

static __STK_UNIT _stack_MoveTask[__TCOUNT_STK_UNIT(512)];
static __STK_UNIT _stack_StopTask[__TCOUNT_STK_UNIT(512)];
static __STK_UNIT _stack_nxtcar[__TCOUNT_STK_UNIT(512)];

const Priority tinib_inipri[TNUM_TASK] = { TPRI_MINTASK + 4, TPRI_MINTASK + 5, TPRI_MINTASK + 3, };
const Priority tinib_exepri[TNUM_TASK] = { TPRI_MINTASK + 4, TPRI_MINTASK + 5, TPRI_MINTASK + 3, };
const UINT8 tinib_maxact[TNUM_TASK] = { (1) - 1, (1) - 1, (1) - 1, };
const AppModeType tinib_autoact[TNUM_TASK] = { 0x00000001, 0x00000001, 0x00000000, };
const FP tinib_task[TNUM_TASK] = { TASKNAME( MoveTask ), TASKNAME( StopTask ), TASKNAME( nxtcar ), };
const __STK_UNIT tinib_stk[TNUM_TASK] = { (__STK_UNIT)_stack_MoveTask, (__STK_UNIT)_stack_StopTask, (__STK_UNIT)_stack_nxtcar, };
...
const TickType alminib_cycle[TNUM_ALARM] = { 50, };
...
const EventMaskType MoveEvent = (1UL << 0);
const EventMaskType StopEvent = (1UL << 1);
